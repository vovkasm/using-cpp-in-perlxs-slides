...
\begin{frame}[t,fragile]
    ...
    \begin{columns}[t]
        ...
        \begin{column}{.8\textwidth}
            ...
            \only<4>{ \lstinputlisting[language=C++, style=PerlXS, firstnumber=last, firstline=17, lastline=34]{CppStat/CppStat.xs} }
            \only<5>{ \lstinputlisting[language=C++, style=PerlXS, firstnumber=last, firstline=36]{CppStat/CppStat.xs} }
        \end{column}
    \end{columns}
\end{frame}
